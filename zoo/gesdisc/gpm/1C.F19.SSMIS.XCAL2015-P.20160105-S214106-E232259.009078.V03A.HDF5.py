...
Usage:  save this script and run
    ...
    python 1C.F19.SSMIS.XCAL2015-P.20160105-S214106-E232259.009078.V03A.HDF5.py
...
def run(FILE_NAME):
    ...
    with h5py.File(FILE_NAME, mode='r') as f:
        ...
        long_name = f[name].attrs['LongName']
...
if __name__ == "__main__":
    ...
    hdffile = '1C.F19.SSMIS.XCAL2015-P.20160105-S214106-E232259.009078.V03A.HDF5'
