...
This example code illustrates how to access and visualize a OBPG CZCS Swath 
...
Usage:  save this script and run
    ...
    python C1978303124834.L2_MLAC.hdf.z.py

The CZCS file must be in the same directory where this script resides.
