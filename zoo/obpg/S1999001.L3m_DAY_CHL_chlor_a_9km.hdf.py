...
This example code illustrates how to access and visualize a OBPG SeaWiFS Grid 
...
Usage:  save this script and run
    ...
    python S1999001.L3m_DAY_CHL_chlor_a_9km.hdf.py
...
plt.title('{0}\n {1} (log scale)'.format(FILE_NAME, long_name[:-1]))
fig = plt.gcf()
