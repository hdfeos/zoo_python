...
This example code illustrates how to access and visualize an OBPG VIIRS Grid 
...
Usage:  save this script and run
    ...
    python V20120012012366.L3m_YR_NPP_KD490_Kd_490_4km.hdf.py
...
m.pcolormesh(latitude, longitude, dataf, latlon=True, cmap=cmap, norm=norm)
